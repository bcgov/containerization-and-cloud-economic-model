...
const endpoint = process.env.CS_CDOGS_ENDPOINT.replace(/\/$/, '');
const tokenEndpoint = process.env.KEYCLOAK_OIDC_ENDPOINT.replace(/\/$/, '');
const username = process.env.CMNSRV_CLIENTID
const password = process.env.CMNSRV_CLIENTSECRET
