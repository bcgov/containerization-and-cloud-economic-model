class Controller {
  constructor(dataService, emailService, pdfService) {
...
class OperationTypesController extends Controller {
  ...
  constructor(dataService, emailService, pdfService) {
    super(dataService, emailService, pdfService);
  }
...
module.exports.OperationTypesController = OperationTypesController;
