...
class Router {
  constructor(slug, controller, models) {
    ...
    this._routes.get('/submissions', middleware.hasRole(this._resourceAccess, ['viewer']), middleware.submissionSearch(this._models), async (req, res, next) => {
...
class OperationTypesRouter extends Router {
  constructor(slug, controller, models) {
    super(slug, controller, models);
...
module.exports.OperationTypesRouter = OperationTypesRouter;
