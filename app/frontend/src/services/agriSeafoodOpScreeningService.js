...
export default {
  ...
  getAllSubmissionData() {
    return appAxios().get(`${ApiRoutes.AGRISEAFOODOPSCREENING}/submissions`);
  },
  ...
  getAllSubmissionMetaData() {
    return appAxios().get(`${ApiRoutes.AGRISEAFOODOPSCREENING}/submissions`, { params: { tiny: true } });
  },
  ...
  getNotes(submissionId) {
    return appAxios().get(`${ApiRoutes.AGRISEAFOODOPSCREENING}/submissions/${submissionId}/notes`);
  },
