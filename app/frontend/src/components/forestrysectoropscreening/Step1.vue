...
export default {
  ...
  computed: {
    ...mapGetters('forestrySectorOpScreeningForm', ['business', 'primaryContact', 'covidContact', 'location']),
  ...
  methods: {
    ...
    ...mapMutations('forestrySectorOpScreeningForm', ['setStep', 'updateBusiness', 'updatePrimaryContact', 'updateCovidContact', 'updateLocation']),
    async submit() {
