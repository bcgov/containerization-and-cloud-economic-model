...
def NAMESPACE = "vmvfjv-tools"
def TAG_NAME = "dev"
def COMPONENT_NAME = "AgriSeafood Op Screening"
def COLLECTION_NAME = "AgriSeafoodOpScreening_v1"
def TESTS_PATH = "app\tests\postman"

// define groovy functions
import groovy.json.JsonOutput

def slave-main_label = "jenkins-slave-main-${UUID.randomUUID().toString()}"
podTemplate(label: slave-main_label, name: slave-main_label, serviceAccount: 'jenkins', cloud: 'openshift', containers: [
    containerTemplate(
        name: 'jnlp',
        image: 'docker-registry.default.svc:5000/vmvfjv-tools/jenkins-slave-main',
